create or replace package body myproj_element_types_api
as
  ...
  (
    pi_eltp_id in myproj_element_types.eltp_id%type
  )
  ...
  begin
    ...
    select to_char(eltp_updated_on, myconstants.gc_timestamp_checksum_fmt)
      into l_return
      from myproj_element_types
  ...
  (
    pio_eltp_id in out myproj_element_types.eltp_id%type
  , pi_eltp_name in myproj_element_types.eltp_name%type
  , pi_eltp_internal_name in myproj_element_types.eltp_internal_name%type 
  ...
  begin
    ...
    if pi_checksum = get_db_checksum(pi_eltp_id => pi_eltp_id) then
      ...
      raise myconstants.e_checksum_mismatch;
    end if;
  ...
  (
    pi_eltp_id in myproj_element_types.eltp_id%type
  , po_eltp_name out nocopy myproj_element_types.eltp_name%type
  , po_eltp_internal_name out nocopy myproj_element_types.eltp_internal_name%type 
  ...
  begin
    ...
    select eltp_name
         , eltp_internal_name
         , to_char(eltp_updated_on, myconstants.gc_timestamp_checksum_fmt)
      into po_eltp_name
